<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultLayout.master" AutoEventWireup="true" CodeFile="displayAllProducts.aspx.cs" Inherits="displayAllProducts" %>
	...
	<div class="tab-pane" id="listView">
		...
		<div class="row">	  
			...
			<div class="span4">
				...
				<h5>Product Name </h5>
				<p>
				Nowadays the industry is one of the most successful business spheres. 
				that is why our goods are so popular..
				</p>
				<a class="btn btn-small pull-right" href="product_details.html">View Details</a>
				<br class="clr">
